...
const filterBar = document.getElementById("filter"); // Filter buttons container
const entriesList = document.getElementById("entries-list"); // Where entries will render
const statsDiv = document.getElementById("stats"); // Where stats will render
